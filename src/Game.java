...
public class Game {
    ...
    public Game() {
        ...
        Mushroom initialSpore = new Mushroom((int) (Math.random() * 500), (int) (Math.random() * 500), collidables, map, 100);
        ...
        for (int i = 0; i < mushrooms.size(); i++) {
            for (int j = 0; j < mushrooms.get(i).size(); j++) {
                if (Math.random() < 1.0 / Math.sqrt(mushrooms.get(i).size()) && mushrooms.get(i).size() < 100) {
                    Mushroom mushroom = new Mushroom((int) (Math.random() * 10 - 5) + mushrooms.get(i).get(j).getX(), (int) (Math.random() * 10 - 5) + mushrooms.get(i).get(j).getY(), getCollidables(), getMap(), 25);
                    ...
                    if (Math.random() < 1.0 / (mushrooms.get(i).size() * mushrooms.size())) {
                        Mushroom newSpore = new Mushroom((int) (Math.random() * 400 - 200) + mushrooms.get(i).get(j).getX(), (int) (Math.random() * 400 - 200) + mushrooms.get(i).get(j).getY(), getCollidables(), getMap(), 100);
